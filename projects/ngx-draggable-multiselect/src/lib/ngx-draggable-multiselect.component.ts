...
import { ListItem, IDropdownSettings } from './models/multi-select.model';

export const DROPDOWN_CONTROL_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  // tslint:disable-next-line: no-use-before-declare
  useExisting: forwardRef(() => NgxDraggableMultiselectComponent),
  multi: true,
};
const noop = () => {};

@Component({
  selector: 'ngx-draggable-multiselect',
  templateUrl: './ngx-draggable-multiselect.component.html',
  styleUrls: ['./ngx-draggable-multiselect.component.scss'],
  providers: [DROPDOWN_CONTROL_VALUE_ACCESSOR],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class NgxDraggableMultiselectComponent implements ControlValueAccessor {
